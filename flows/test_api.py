...
class GraphFilesTest(unittest.TestCase):
    def test_default_is_case_dag(self):
        ...
        self.assertEqual(lab[0]["label"], "CyberGym subset")
        self.assertEqual(lab[0]["config"]["program"], "cybergym")
        ...
        self.assertEqual(graph["metadata"]["lab"]["last_score"], "1/10")
        self.assertEqual(graph["metadata"]["score"], "1/10")
        ...
        self.assertEqual(graph["metadata"]["lab"].get("n"), 1)
        self.assertEqual(graph["metadata"]["lab"].get("N"), 10)
        self.assertEqual(graph["metadata"]["lab"].get("bind"), "127.0.0.1:8666")
        self.assertEqual(graph["metadata"]["lab"].get("score_path"), "POST /query-poc task_id=arvo:3938")
        self.assertEqual(graph["version"], "1.19.0")
        report_to_harden = [
    ...
    def test_studio_shows_score_and_wall_pills(self):
        ...
        self.assertIn("Score is the CyberGym PoC server n/N or its fail text", html)
        ...
        self.assertEqual(template["metadata"]["lab"]["wall"], "subset-10")
        self.assertEqual(template["metadata"]["lab"]["hunted"], "subset-10")
        self.assertEqual(template["metadata"]["lab"]["program"], "cybergym")
        self.assertEqual(template["metadata"]["lab"].get("N"), 10)
        self.assertEqual(template["metadata"]["lab"].get("bind"), "127.0.0.1:8666")
...
class ApiTest(unittest.TestCase):
    ...
    def test_empty_post_upserts_template(self):
        ...
        self.assertEqual(listed["graphs"][0].get("wall"), "subset-10")
        ...
        self.assertEqual(listed["graphs"][0].get("score_path"), "POST /query-poc task_id=arvo:3938")
    ...
    def test_cybergym_score_without_scope_file_fails_closed(self):
        code, data = get_status(f"{self.base}/api/case/score?program=cybergym")
        self.assertEqual(code, 400)
        self.assertTrue(data.get("fail_closed"))
