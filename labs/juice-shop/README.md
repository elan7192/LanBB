...
| `overlays/v3-hardened/` | Previous wall: v2 plus method allowlist, URI WAF, cookie flags, COEP/HSTS, read-only edge, upload/PII/chatbot/B2B/snippets closed |
| `overlays/v4-hardened/` | Current wall: v3 plus juice process caps, origin/UA deny, CORS strip, stronger WAF signatures, registration/search/reviews/baskets/captcha/privacy closed |
