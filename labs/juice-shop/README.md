...
| `overlays/v6-hardened/` | Previous wall: working harden (no juice EROFS, no tmpfs over data/static) plus login closed, GET/HEAD only, SPA/static leak closed |
| `overlays/v7-hardened/` | Current wall: working harden plus default-deny unmatched GET/HEAD, leftover SPA/JS, remaining /api /rest closed except Challenges |
